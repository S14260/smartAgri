...
public class LlmServiceImpl implements LlmService {
    ...
    public String explainAnomaly(AnomalyRecordDTO record) throws Exception {
        ...
        messages.add(objectMapper.createObjectNode().put("role", "user").put("content", userPrompt.toString()));
        ...
        if (!response.isSuccessful()) {
            throw new RuntimeException("调用 LLM 失败: " + response.code() + " " + response.message());
        }
